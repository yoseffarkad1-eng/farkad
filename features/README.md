...
| `next` | The briefs written for whoever comes next. `brief-for-opus.md` (the eight items after v98) is **done** — see `false-holds`. `opus-closeout.md` is the wave plan this line is working through; its Wave 0 shipped as v99 and its Wave 1, both halves, as v100. | briefs |
